...
#> O set é usado para armazenar vários itens em uma única variável. Além disso, é importante ressaltar que no set, utilizamos as chaves. Diferentemente de outros tipos, o set não permite não possibilita recuperar valores via fatiamento.
