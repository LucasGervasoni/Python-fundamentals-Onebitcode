...
#> As tuplas são usadas para armazenar vários itens em uma única variável. Além disso, é importante ressaltar que na lista, utilizamos os parêntesis Diferentemente de uma lista, uma tupla não permite adicionar, remover nem ordenar valores.
